...
export const metadata: Metadata = {
  title: "MarketFlow - Digital Marketing Solutions for Business Growth",
  description: "Transform your marketing strategy with our data-driven solutions. Lead generation, social media management, and analytics expertise for growing businesses.",
  keywords: "digital marketing, marketing strategy, lead generation, social media management, marketing agency",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "MarketFlow - Digital Marketing Solutions",
    description: "Revolutionize your marketing with data-driven strategies and creative excellence.",
    type: "website",
    siteName: "MarketFlow",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1765796664042-6fhs373o.jpg",
      alt: "MarketFlow - Digital Marketing Solutions"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "MarketFlow - Transform Your Marketing",
    description: "Join hundreds of businesses growing with our marketing expertise.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1765796664042-6fhs373o.jpg"]
  }
};
